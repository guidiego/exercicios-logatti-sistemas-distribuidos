...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\chat.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" server.ChatServer %CMD_LINE_ARGS%
